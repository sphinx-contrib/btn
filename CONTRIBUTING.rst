...
Thank you for your help improving **sphinx-btn**!

**sphinx-btn** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **sphinx-btn** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/{{ YOUR USERNAME }}/btn
   cd btn
...
This will install the **sphinx-btn** library, together with two additional tools:
